...
# (kind, id, art_id, title, next, alt, font)
ARTS = [
    ("product", 1074894186, None, "Laptop Dell Inspiron 3530 i7-1355U cũ đẹp",
     "Keo tản nhiệt kim loại lỏng là gì?", "Laptop Dell Inspiron 3530 i7-1355U cũ", PROD_S),
    ("blog", 1000960873, 1002728484, "Keo tản nhiệt kim loại lỏng là gì?",
     "Cấu hình chơi Naraka: Bladepoint trên PC, laptop", "Keo tản nhiệt kim loại lỏng", BLOG_S),
    ("blog", 1000906526, 1002399833, "Cấu hình chơi Naraka: Bladepoint trên PC, laptop",
     "Cách xóa watermark trong Photoshop trên ảnh bạn có quyền chỉnh", "Cấu hình chơi Naraka", BLOG_S),
    ("blog", 1000906526, 1002420321, "Cách xóa watermark trong Photoshop trên ảnh bạn có quyền chỉnh",
     None, "Xóa watermark trong Photoshop", BLOG_S),
]
CACHE = {}
...
for kind, oid, aid, title, nxt, alt, S in ARTS:
    ...
    Path("data/_b4_%s_OLD_%s.html" % (aid or oid, time.strftime("%H%M%S"))).write_text(old, encoding="utf-8")
