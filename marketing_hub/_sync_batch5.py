...
ARTS = [
    ("blog", 1000906526, 1002398522, "Sửa laptop Quận 7 tại Sintech",
     "Cách khôi phục file đã xóa trên máy tính Windows 11", "Sửa laptop Quận 7 Sintech", BLOG_S, False),
    ("blog", 1000906526, 1002430893, "Cách khôi phục file đã xóa trên máy tính Windows 11",
     "Cách khôi phục file đã xóa trên máy tính Windows 11", "Khôi phục file đã xóa Windows 11", BLOG_S, True),  # next=title -> cắt bản lặp đôi
    ("product", 1055504339, None, "Ghế Gaming CENTAUR LEGEND",
     None, "Ghế Gaming CENTAUR LEGEND", PROD_S, True),
]
CACHE = {}
