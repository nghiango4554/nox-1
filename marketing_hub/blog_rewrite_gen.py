...
- KHÔNG tạo số benchmark/FPS, KHÔNG tạo giá cụ thể, KHÔNG tạo ngày phát hành/timeline, KHÔNG tạo claim driver/phiên bản mới nếu không có nguồn chính thức. Bài khái niệm/how-to: viết định tính, tránh số liệu time-sensitive.
